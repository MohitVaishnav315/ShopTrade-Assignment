...
var newarr=[];
var id=0;
arr.forEach(function(donutSummary) {

var name = arr[i].name;
 id = arr[i].id;
var imgsrc=arr[i].image_src;
var headingvalue=arr[i].vendor;
var pricevalue=arr[i].price;
var pricevalue2=arr[i].compare_at_price;
for(var x=0;x<arr[i].options.length;x++)
{
    newarr[x]=arr[i].options[x].value;
}
//alert(newarr);


    var outerdiv = document.createElement('div');
    outerdiv.setAttribute("class", "col-sm-2 mr-4");

    innerdiv=document.createElement('div');
    innerdiv.setAttribute("class", "card");
    innerdiv.setAttribute("width", "262px");
    innerdiv.setAttribute("id","cardid"+id);
    ...
    para2.setAttribute("class","card-text-1");
    para2.innerHTML='$'+pricevalue;

    var span1=document.createElement('span');
    span1.setAttribute("class","span1");
    span1.innerHTML='$'+pricevalue2;


    var span2=document.createElement('span');
    span2.setAttribute("class","span2");
    span2.innerHTML='(50% OFF)';


    var para3=document.createElement('p');
    para3.setAttribute("class","card-text");
    para3.innerHTML="["+newarr+"]";
    ...
    innerdiv2.appendChild(addtocartbtn);
    innerdiv2.appendChild(para3);
...
document.getElementById("cardid"+arr[y].id).addEventListener("click", function() {
    alert("card no. "+y);
  });
